...
var comma2, semicolon, chars2, intToChar2, charToInt2, bufLength, td, _StringWriter, StringWriter;
var init_sourcemap_codec = __esm({
  "node_modules/@jridgewell/sourcemap-codec/dist/sourcemap-codec.mjs"() {
    ...
    _StringWriter = class _StringWriter {
      constructor() {
        this.pos = 0;
        this.out = "";
    ...
    __name(_StringWriter, "StringWriter");
...
var _BitSet, BitSet, _Chunk, Chunk, btoa, _SourceMap, SourceMap, toString4, wordRegex, _Mappings, Mappings, n, warned, _MagicString, MagicString, hasOwnProp, _Bundle, Bundle;
var init_magic_string_es = __esm({
  "node_modules/magic-string/dist/magic-string.es.mjs"() {
    "use strict";
    init_sourcemap_codec();
    _BitSet = class _BitSet {
      constructor(arg) {
    ...
    _MagicString = class _MagicString {
    ...
    MagicString = _MagicString;
    hasOwnProp = Object.prototype.hasOwnProperty;
    _Bundle = class _Bundle {
      constructor(options = {}) {
...
var require_dist = __commonJS({
  "node_modules/expect-type/dist/index.js"(exports2) {
    ...
    var __exportStar = exports2 && exports2.__exportStar || function(m3, exports1) {
      for (var p3 in m3) if (p3 !== "default" && !Object.prototype.hasOwnProperty.call(exports1, p3)) __createBinding(exports1, m3, p3);
    };
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
    ...
    var fn2 = /* @__PURE__ */ __name(() => true, "fn");
    var expectTypeOf2 = /* @__PURE__ */ __name((_actual) => {
      ...
      getterProperties.forEach((prop) => Object.defineProperty(obj, prop, {
        get: /* @__PURE__ */ __name(() => (0, exports2.expectTypeOf)({}), "get")
      }));
      return obj;
    }, "expectTypeOf");
...
__name(C, "C");
function p(n2 = false) {
  let e = C(n2), i = /* @__PURE__ */ __name((r2, t, c, o) => {
    let l2 = "", s2 = 0;
    do
      l2 += r2.substring(s2, o) + c, s2 = o + t.length, o = r2.indexOf(t, s2);
    while (~o);
    return l2 + r2.substring(s2);
  }, "i"), g = /* @__PURE__ */ __name((r2, t, c = r2) => {
    let o = /* @__PURE__ */ __name((l2) => {
    ...
    isColorSupported: e
  }, d2 = /* @__PURE__ */ __name((r2) => `\x1B[${r2}m`, "d");
  for (let [r2, t] of h) u3[r2] = e ? g(d2(t[0]), d2(t[1]), t[2]) : a;
  return u3;
}
__name(p, "p");
...
var SPACE$2 = " ";
var serialize$5 = /* @__PURE__ */ __name((val, config2, indentation, depth, refs, printer2) => {
...
var serialize$4 = /* @__PURE__ */ __name((collection, config2, indentation, depth, refs, printer2) => {
  const name = collection.constructor.name;
  if (++depth > config2.maxDepth) {
    return `[${name}]`;
  }
  return (config2.min ? "" : name + SPACE$1) + (OBJECT_NAMES.has(name) ? `{${printObjectProperties(isNamedNodeMap(collection) ? [
    ...collection
    ...
    ...collection
  }, config2, indentation, depth, refs, printer2)}}` : `[${printListItems([
    ...collection
  ], config2, indentation, depth, refs, printer2)}]`);
}, "serialize$4");
var plugin$4 = {
...
var test$3 = /* @__PURE__ */ __name((val) => {
  var _a24;
  return ((_a24 = val == null ? void 0 : val.constructor) == null ? void 0 : _a24.name) && testNode(val);
}, "test$3");
...
var serialize$3 = /* @__PURE__ */ __name((node, config2, indentation, depth, refs, printer2) => {
  if (nodeIsText(node)) {
  ...
  return printElement(type3, printProps(nodeIsFragment(node) ? [] : Array.from(node.attributes, (attr) => attr.name).sort(), nodeIsFragment(node) ? {} : [
    ...node.attributes
  ].reduce((props, attribute) => {
    props[attribute.name] = attribute.value;
    return props;
...
var serialize$2 = /* @__PURE__ */ __name((val, config2, indentation, depth, refs, printer2) => {
...
var ReactIs = Object.fromEntries(reactIsMethods.map((m3) => [
  m3,
  (v) => ReactIs18[m3](v) || ReactIs19[m3](v)
]));
...
var serialize = /* @__PURE__ */ __name((object2, config2, indentation, depth, refs, printer2) => ++depth > config2.maxDepth ? printElementAsLeaf(object2.type, config2) : printElement(object2.type, object2.props ? printProps(getPropKeys(object2), object2.props, config2, indentation + config2.indent, depth, refs, printer2) : "", object2.children ? printChildren(object2.children, config2, indentation + config2.indent, depth, refs, printer2) : "", config2, indentation), "serialize");
...
__name(createSimpleStackTrace, "createSimpleStackTrace");
...
__name(createDefer, "createDefer");
...
function requireJsTokens() {
  ...
  jsTokens_1 = /* @__PURE__ */ __name(function* (input, { jsx = false } = {}) {
...
function getSafeTimers() {
  ...
  const { nextTick: safeNextTick } = globalThis[SAFE_TIMERS_SYMBOL] || globalThis.process || {
    nextTick: /* @__PURE__ */ __name((cb) => cb(), "nextTick")
  };
  return {
...
function requireBuild() {
  ...
  const extendPathsF = /* @__PURE__ */ __name((d2, aEnd, bEnd, bF, isCommon, aIndexesF, iMaxF) => {
    let iF = 0;
    let kF = -d2;
  ...
  const extendPathsR = /* @__PURE__ */ __name((d2, aStart, bStart, bR, isCommon, aIndexesR, iMaxR) => {
    let iR = 0;
    let kR = d2;
  ...
  const extendOverlappablePathsF = /* @__PURE__ */ __name((d2, aStart, aEnd, bStart, bEnd, isCommon, aIndexesF, iMaxF, aIndexesR, iMaxR, division) => {
  ...
  const extendOverlappablePathsR = /* @__PURE__ */ __name((d2, aStart, aEnd, bStart, bEnd, isCommon, aIndexesF, iMaxF, aIndexesR, iMaxR, division) => {
    const bR = bEnd - aEnd;
    const aLength = aEnd - aStart;
    const bLength = bEnd - bStart;
    const baDeltaLength = bLength - aLength;
  ...
  const divide = /* @__PURE__ */ __name((nChange, aStart, aEnd, bStart, bEnd, isCommon, aIndexesF, aIndexesR, division) => {
    ...
    if (baDeltaLength % 2 === 0) {
      ...
      for (d2 += 1; d2 <= dMax; d2 += 1) {
        iMaxR = extendPathsR(d2 - 1, aStart, bStart, bR, isCommon, aIndexesR, iMaxR);
        if (d2 < dMin) {
          iMaxF = extendPathsF(d2, aEnd, bEnd, bF, isCommon, aIndexesF, iMaxF);
        } else if (
...
var noColor = /* @__PURE__ */ __name((string2) => string2, "noColor");
...
function diffStrings(a3, b, options) {
  ...
  if (truncate3) {
    ...
    const _a24 = aMultipleLines ? `${a3.split(aNewLineSymbol, truncateThreshold).join(aNewLineSymbol)}
` : a3;
...
` : b;
  ...
  const isCommon = /* @__PURE__ */ __name((aIndex2, bIndex2) => a3[aIndex2] === b[bIndex2], "isCommon");
  let aIndex = 0;
  let bIndex = 0;
  const diffs = [];
  const foundSubsequence = /* @__PURE__ */ __name((nCommon, aCommon, bCommon) => {
...
}, __name(_a3, "ChangeBuffer"), _a3);
var _a4;
var CommonBuffer = (_a4 = class {
...
function diff(a3, b, options) {
  ...
  if (expectedType !== getType3(b)) {
    let truncate22 = /* @__PURE__ */ __name(function(s2) {
...
var P = /* @__PURE__ */ __name((e) => {
  e.called = false, e.callCount = 0, e.calls = [], e.results = [], e.resolves = [], e.next = [];
}, "P");
var K = /* @__PURE__ */ __name((e) => (f2(e, u2, {
  value: {
    reset: /* @__PURE__ */ __name(() => P(e[u2]), "reset")
  }
}), e[u2]), "K");
var T = /* @__PURE__ */ __name((e) => e[u2] || K(e), "T");
function m2(e) {
  d(y("function", e) || y("undefined", e), "cannot spy on a non-function value");
  let t = /* @__PURE__ */ __name(function(...s2) {
    let r2 = T(t);
    ...
    if (r2.impl) try {
      ...
      throw p3 = o, c = "error", r2.results.push([
        c,
        o
      ]), o;
    }
    ...
    return w(p3) && p3.then((o) => r2.resolves[a3] = [
      "ok",
      o
    ], (o) => r2.resolves[a3] = [
      "error",
...
__name(m2, "m");
var k = /* @__PURE__ */ __name((e, t) => Object.getOwnPropertyDescriptor(e, t), "k");
...
function C2(e, t, n2) {
  ...
  d(a3 || s2 in e, `${String(s2)} does not exist`);
  let R = false;
  r2 === "value" && a3 && !a3.value && a3.get && (r2 = "get", R = true, n2 = a3.get());
  let o;
  a3 ? o = a3[r2] : r2 !== "value" ? o = /* @__PURE__ */ __name(() => e[s2], "o") : o = e[s2];
  let g = /* @__PURE__ */ __name((v) => {
    let { value: M, ...h3 } = a3 || {
      configurable: true,
      writable: true
    };
    r2 !== "value" && delete h3.writable, h3[r2] = v, f2(e, s2, h3);
  }, "g"), b = /* @__PURE__ */ __name(() => a3 ? f2(e, s2, a3) : g(o), "b");
  n2 || (n2 = o);
  let i = m2(n2);
  r2 === "value" && O(i, o);
  let I = i[u2];
  return l(I, "restore", b), l(I, "getOriginal", () => R ? o() : o), l(I, "willCall", (v) => (I.impl = v, i)), g(R ? () => (O(i, n2), i) : i), x.add(i), i;
}
__name(C2, "C");
...
function enhanceSpy(spy) {
  ...
  Object.defineProperty(stub, "mock", {
    get: /* @__PURE__ */ __name(() => mockContext, "get")
  });
  state.willCall(mockCall);
  mocks.add(stub);
  return stub;
...
__export2(utils_exports, {
  ...
  objDisplay: /* @__PURE__ */ __name(() => objDisplay2, "objDisplay"),
...
var _a5;
var AssertionError = (_a5 = class extends Error {
  constructor(message = "Unspecified AssertionError", props, ssf) {
    super(message);
    __publicField(this, "message");
    this.message = message;
    if (canElideFrames) {
      Error.captureStackTrace(this, ssf || _a5);
    }
...
}, __name(_a5, "_AssertionError"), __name2(_a5, "AssertionError"), _a5);
...
function inspectArray2(array2, options) {
  ...
  let propertyContents = "";
  if (nonIndexProperties.length) {
    propertyContents = inspectList2(nonIndexProperties.map((key) => [
      key,
      array2[key]
...
var getArrayName2 = /* @__PURE__ */ __name2((array2) => {
  if (typeof Buffer === "function" && array2 instanceof Buffer) {
    return "Buffer";
  }
  if (array2[Symbol.toStringTag]) {
...
function inspectObject3(object2, options) {
  ...
  options.seen.push(object2);
  const propertyContents = inspectList2(properties.map((key) => [
    key,
    object2[key]
  ]), options, inspectProperty2);
  const symbolContents = inspectList2(symbols.map((key) => [
    key,
    object2[key]
  ]), options, inspectProperty2);
  options.seen.pop();
...
function inspectHTML2(element, options) {
  ...
  if (properties.length > 0) {
    propertyContents += " ";
    propertyContents += inspectList2(properties.map((key) => [
      key,
      element.getAttribute(key)
    ]), options, inspectAttribute2, " ");
  }
  options.truncate -= propertyContents.length;
...
Assertion.addProperty("numeric", function() {
  ...
  this.assert([
    "Number",
    "BigInt"
  ].includes(type(object2)), "expected #{this} to be numeric", "expected #{this} to not be numeric", flag2(this, "negate") ? false : true);
});
...
function closeTo(expected, delta, msg) {
  ...
  const abs = /* @__PURE__ */ __name2((x2) => x2 < 0n ? -x2 : x2, "abs");
...
function isErrorEqual(a3, b, aStack, bStack, customTesters, hasKey2) {
  ...
  result && (result = eq({
    ...
    ...b
  }, aStack, bStack, customTesters, hasKey2));
  return result;
}
...
function iterableEquality(a3, b, customTesters = [], aStack = [], bStack = []) {
  ...
  function iterableEqualityWithStack(a22, b2) {
    return iterableEquality(a22, b2, [
      ...customTesters
    ], [
      ...aStack
    ], [
...
function subsetEquality(object2, subset, customTesters = []) {
  ...
  const subsetEqualityWithContext = /* @__PURE__ */ __name((seenReferences = /* @__PURE__ */ new WeakMap()) => (object22, subset2) => {
...
function getObjectKeys(object2) {
  return [
    ...
    ...Object.getOwnPropertySymbols(object2).filter((s2) => {
      var _a24;
      return (_a24 = Object.getOwnPropertyDescriptor(object2, s2)) == null ? void 0 : _a24.enumerable;
    })
  ];
}
...
function getObjectSubset(object2, subset, customTesters) {
  let stripped = 0;
  const getObjectSubsetWithContext = /* @__PURE__ */ __name((seenReferences = /* @__PURE__ */ new WeakMap()) => (object22, subset2) => {
    if (Array.isArray(object22)) {
      if (Array.isArray(subset2) && subset2.length === object22.length) {
        return subset2.map((sub, i) => getObjectSubsetWithContext(seenReferences)(object22[i], sub));
      }
...
if (!Object.prototype.hasOwnProperty.call(globalThis, MATCHERS_OBJECT)) {
  ...
  Object.defineProperty(globalThis, MATCHERS_OBJECT, {
    get: /* @__PURE__ */ __name(() => globalState, "get")
  });
  ...
  Object.defineProperty(globalThis, ASYMMETRIC_MATCHERS_OBJECT, {
    get: /* @__PURE__ */ __name(() => asymmetricMatchers, "get")
  });
}
...
var _a6;
var AsymmetricMatcher3 = (_a6 = class {
...
}, __name(_a6, "AsymmetricMatcher"), _a6);
...
var _a7;
var StringContaining = (_a7 = class extends AsymmetricMatcher3 {
  constructor(sample, inverse = false) {
...
}, __name(_a7, "StringContaining"), _a7);
var _a8;
var Anything = (_a8 = class extends AsymmetricMatcher3 {
  asymmetricMatch(other) {
    return other != null;
  }
  toString() {
...
}, __name(_a8, "Anything"), _a8);
var _a9;
var ObjectContaining = (_a9 = class extends AsymmetricMatcher3 {
  constructor(sample, inverse = false) {
    super(sample, inverse);
  }
  getPrototype(obj) {
...
}, __name(_a9, "ObjectContaining"), _a9);
var _a10;
var ArrayContaining = (_a10 = class extends AsymmetricMatcher3 {
  constructor(sample, inverse = false) {
    super(sample, inverse);
  }
  asymmetricMatch(other) {
...
}, __name(_a10, "ArrayContaining"), _a10);
var _a11;
var Any = (_a11 = class extends AsymmetricMatcher3 {
  constructor(sample) {
...
}, __name(_a11, "Any"), _a11);
var _a12;
var StringMatching = (_a12 = class extends AsymmetricMatcher3 {
  constructor(sample, inverse = false) {
...
}, __name(_a12, "StringMatching"), _a12);
var _a13;
var CloseTo = (_a13 = class extends AsymmetricMatcher3 {
...
}, __name(_a13, "CloseTo"), _a13);
var JestAsymmetricMatchers = /* @__PURE__ */ __name((chai2, utils) => {
...
function recordAsyncExpect(_test2, promise, assertion, error) {
  ...
  if (test5 && promise instanceof Promise) {
    ...
    test5.onFinished.push(() => {
      var _a24;
      if (!resolved) {
        const processor = ((_a24 = globalThis.__vitest_worker__) == null ? void 0 : _a24.onFilterStackTrace) || ((s2) => s2 || "");
...
function wrapAssertion(utils, name, fn2) {
  return function(...args) {
    ...
    try {
      ...
      (_a24 = test5.result).errors || (_a24.errors = []);
      test5.result.errors.push(processError(err));
    }
  };
}
__name(wrapAssertion, "wrapAssertion");
var JestChaiExpect = /* @__PURE__ */ __name((chai2, utils) => {
...
(${stripped} matching ${stripped === 1 ? "property" : "properties"} omitted from actual)`;
  ...
  def([
    ...
    const spy = getSpy2(this);
    const spyName = spy.getMockName();
    const pass = spy.mock.calls.some((callArg) => equals(callArg, args, [
      ...customTesters,
      iterableEquality
    ]));
    const isNot = utils.flag(this, "negate");
  ...
  def("toHaveBeenCalledExactlyOnceWith", function(...args) {
    ...
    const spyName = spy.getMockName();
    const callCount = spy.mock.calls.length;
    const hasCallWithArgs = spy.mock.calls.some((callArg) => equals(callArg, args, [
      ...customTesters,
      iterableEquality
    ]));
  ...
  def([
    ...
    this.assert(equals(nthCall, args, [
      ...customTesters,
      iterableEquality
    ]), `expected ${ordinalOf(times)} "${spyName}" call to have been called with #{exp}${isCalled ? `` : `, but called only ${callCount} times`}`, `expected ${ordinalOf(times)} "${spyName}" call to not have been called with #{exp}`, args, nthCall, isCalled);
  });
  def([
    ...
    this.assert(equals(lastCall, args, [
      ...customTesters,
      iterableEquality
    ]), `expected last "${spyName}" call to have been called with #{exp}`, `expected last "${spyName}" call to not have been called with #{exp}`, args, lastCall);
  });
  ...
  [
    {
      name: "toHaveResolved",
      condition: /* @__PURE__ */ __name((spy) => spy.mock.settledResults.length > 0 && spy.mock.settledResults.some(({ type: type3 }) => type3 === "fulfilled"), "condition"),
      action: "resolved"
    },
    {
      name: [
      ...
      condition: /* @__PURE__ */ __name((spy) => spy.mock.calls.length > 0 && spy.mock.results.some(({ type: type3 }) => type3 !== "throw"), "condition"),
      action: "called"
    }
  ...
  [
    {
      ...
      condition: /* @__PURE__ */ __name((spy, times) => spy.mock.settledResults.reduce((s2, { type: type3 }) => type3 === "fulfilled" ? ++s2 : s2, 0) === times, "condition"),
      action: "resolved"
    },
    {
      name: [
      ...
      condition: /* @__PURE__ */ __name((spy, times) => spy.mock.results.reduce((s2, { type: type3 }) => type3 === "throw" ? s2 : ++s2, 0) === times, "condition"),
      action: "called"
    }
  ].forEach(({ name, condition, action }) => {
  ...
  [
    {
      ...
      condition: /* @__PURE__ */ __name((spy, value) => spy.mock.settledResults.some(({ type: type3, value: result }) => type3 === "fulfilled" && equals(value, result)), "condition"),
      action: "resolve"
    },
    {
      name: [
      ...
      condition: /* @__PURE__ */ __name((spy, value) => spy.mock.results.some(({ type: type3, value: result }) => type3 === "return" && equals(value, result)), "condition"),
      action: "return"
    }
  ].forEach(({ name, condition, action }) => {
  ...
  utils.addProperty(chai2.Assertion.prototype, "resolves", /* @__PURE__ */ __name(function __VITEST_RESOLVES__() {
  ...
  utils.addProperty(chai2.Assertion.prototype, "rejects", /* @__PURE__ */ __name(function __VITEST_REJECTS__() {
...
var _a14;
var JestExtendError = (_a14 = class extends Error {
  constructor(message, actual, expected) {
    super(message);
    this.actual = actual;
    this.expected = expected;
  }
}, __name(_a14, "JestExtendError"), _a14);
function JestExtendPlugin(c, expect2, matchers) {
  return (_, utils) => {
    Object.entries(matchers).forEach(([expectAssertionName, expectAssertion]) => {
      ...
      let CustomMatcher = (_a24 = class extends AsymmetricMatcher3 {
      ...
      }, __name(_a24, "CustomMatcher"), _a24);
...
var JestExtend = /* @__PURE__ */ __name((chai2, utils) => {
...
var isAbsolute = /* @__PURE__ */ __name(function(p3) {
...
__name(parseSingleFFOrSafariStack, "parseSingleFFOrSafariStack");
...
__name(parseSingleStack, "parseSingleStack");
...
var isAbsolute2 = /* @__PURE__ */ __name(function(p3) {
...
function createChainable(keys2, fn2) {
  function create(context) {
    const chain2 = /* @__PURE__ */ __name(function(...args) {
...
__name(getTestName, "getTestName");

// node_modules/@vitest/runner/dist/index.js
var _a15;
var PendingError = (_a15 = class extends Error {
...
function collectTask(task) {
  var _a24;
  (_a24 = collectorContext.currentSuite) == null ? void 0 : _a24.tasks.push(task);
}
__name(collectTask, "collectTask");
...
function withTimeout(fn2, timeout, isHook = false) {
  ...
  return /* @__PURE__ */ __name(function runWithTimeout(...args) {
    ...
    return new Promise((resolve_, reject_) => {
      ...
      (_a24 = timer.unref) == null ? void 0 : _a24.call(timer);
...
function createTestContext(test5, runner2) {
  var _a24;
  const context = /* @__PURE__ */ __name(function() {
  ...
  context.onTestFailed = (handler, timeout) => {
    ...
    test5.onFailed.push(withTimeout(handler, timeout ?? runner2.config.hookTimeout, true));
  };
  context.onTestFinished = (handler, timeout) => {
    test5.onFinished || (test5.onFinished = []);
    test5.onFinished.push(withTimeout(handler, timeout ?? runner2.config.hookTimeout, true));
  };
  return ((_a24 = runner2.extendTaskContext) == null ? void 0 : _a24.call(runner2, context)) || context;
}
...
__name(makeTimeoutMsg, "makeTimeoutMsg");
...
__name(setFixture, "setFixture");
function getFixture(key) {
  return fixtureMap.get(key);
}
__name(getFixture, "getFixture");
...
function withFixtures(fn2, testContext) {
  return (hookContext) => {
    ...
    __name(resolveFixtures, "resolveFixtures");
    return resolveFixtures().then(() => fn2(context));
  };
}
__name(withFixtures, "withFixtures");
...
__name(resolveFixtureFunction, "resolveFixtureFunction");
...
__name(getCurrentSuite, "getCurrentSuite");
...
__name(createSuiteHooks, "createSuiteHooks");
function parseArguments(optionsOrFn, optionsOrTest) {
  let options = {};
  let fn2 = /* @__PURE__ */ __name(() => {
  }, "fn");
...
function createSuiteCollector(name, factory = () => {
  ...
  let suite2;
  initSuite(true);
  const task = /* @__PURE__ */ __name(function(name2 = "", options = {}) {
    const task2 = {
      id: "",
      name: name2,
      suite: void 0,
    ...
    if (handler) {
      setFn(task2, withTimeout(withAwaitAsyncAssertions(withFixtures(handler, context), task2), (options == null ? void 0 : options.timeout) ?? runner.config.testTimeout));
    }
...
__name(createSuiteCollector, "createSuiteCollector");
...
function createSuite() {
  function suiteFn(name, factoryOrOptions, optionsOrFactory) {
    ...
    options = {
      ...
      ...options,
      shuffle: this.shuffle ?? options.shuffle ?? ((_a24 = currentSuite == null ? void 0 : currentSuite.options) == null ? void 0 : _a24.shuffle) ?? (runner == null ? void 0 : runner.config.sequence.shuffle)
    };
...
function createTaskCollector(fn2, context) {
  ...
  taskFn.each = function(cases, ...args) {
    ...
    return (name, optionsOrFn, fnOrOptions) => {
      ...
      cases.forEach((i, idx) => {
        ...
        if (fnFirst) {
          if (arrayOnlyCases) {
            test22(formatTitle(_name, items, idx), () => handler(...items), options);
          } else {
  ...
  taskFn.extend = function(fixtures) {
    const _context = mergeContextFixtures(fixtures, context || {}, (key) => {
      var _a24, _b;
      return (_b = (_a24 = getRunner()).injectValue) == null ? void 0 : _b.call(_a24, key);
    });
    return createTest(/* @__PURE__ */ __name(function fn22(name, optionsOrFn, optionsOrTest) {
      getCurrentSuite().test.fn.call(this, formatName(name), optionsOrFn, optionsOrTest);
    }, "fn2"), _context);
  };
...
__name(createTaskCollector, "createTaskCollector");
    ...
    formatted = formatted.replace(
      ...
      (_, key) => {
        ...
        return objDisplay(objectAttr(items[0], key), {
          truncate: (_b = (_a24 = runner == null ? void 0 : runner.config) == null ? void 0 : _a24.chaiConfig) == null ? void 0 : _b.truncateThreshold
        });
      }
    );
  }
...
__name(formatTemplateString, "formatTemplateString");
...
__name(findTestFileStackTrace, "findTestFileStackTrace");
function getDefaultHookTimeout() {
  return getRunner().config.hookTimeout;
}
__name(getDefaultHookTimeout, "getDefaultHookTimeout");
var onTestFailed = createTestHook("onTestFailed", (test5, handler, timeout) => {
  test5.onFailed || (test5.onFailed = []);
  test5.onFailed.push(withTimeout(handler, timeout ?? getDefaultHookTimeout(), true));
});
var onTestFinished = createTestHook("onTestFinished", (test5, handler, timeout) => {
  test5.onFinished || (test5.onFinished = []);
  test5.onFinished.push(withTimeout(handler, timeout ?? getDefaultHookTimeout(), true));
});
function createTestHook(name, handler) {
  return (fn2, timeout) => {
    assertTypes(fn2, `"${name}" callback`, [
      "function"
    ]);
...
__name(getWorkerState, "getWorkerState");
...
__name(isChildProcess, "isChildProcess");
...
__name(waitNextTick, "waitNextTick");
...
function decodedMappings(map2) {
  var _a24;
  return (_a24 = cast(map2))._decoded || (_a24._decoded = decode(cast(map2)._encoded));
}
...
__name(notNullish2, "notNullish");
function isPrimitive3(value) {
  return value === null || typeof value !== "function" && typeof value !== "object";
}
__name(isPrimitive3, "isPrimitive");
...
__name(getCallLastIndex2, "getCallLastIndex");
...
__name(extractLocation2, "extractLocation");
...
__name(parseSingleFFOrSafariStack2, "parseSingleFFOrSafariStack");
...
function parseStacktrace(stack, options = {}) {
  ...
  return stacks.map((stack2) => {
    ...
    const map2 = (_a24 = options.getSourceMap) == null ? void 0 : _a24.call(options, stack2.file);
...
__name(parseStacktrace, "parseStacktrace");
function parseFFOrSafariStackTrace(stack) {
  return stack.split("\n").map((line) => parseSingleFFOrSafariStack2(line)).filter(notNullish2);
}
__name(parseFFOrSafariStackTrace, "parseFFOrSafariStackTrace");
function parseV8Stacktrace(stack) {
  return stack.split("\n").map((line) => parseSingleV8Stack2(line)).filter(notNullish2);
}
__name(parseV8Stacktrace, "parseV8Stacktrace");
...
__name(parseErrorStacktrace, "parseErrorStacktrace");
var getPromiseValue3 = /* @__PURE__ */ __name(() => "Promise{\u2026}", "getPromiseValue");
try {
  const { getPromiseDetails, kPending, kRejected } = process.binding("util");
  if (Array.isArray(getPromiseDetails(Promise.resolve()))) {
    getPromiseValue3 = /* @__PURE__ */ __name((value, options) => {
      const [state, innerValue] = getPromiseDetails(value);
      if (state === kPending) {
        return "Promise{<pending>}";
      }
...
__name(getDefaultExportFromCjs4, "getDefaultExportFromCjs");
var jsTokens_12;
...
function requireJsTokens2() {
  ...
  KeywordsWithNoLineTerminatorAfter = /^(?:return|throw|yield)$/;
  Newline = RegExp(LineTerminatorSequence.source);
  jsTokens_12 = /* @__PURE__ */ __name(function* (input, { jsx = false } = {}) {
    var braces, firstCodePoint, isExpression, lastIndex, lastSignificantToken, length, match, mode, nextLastIndex, nextLastSignificantToken, parenNesting, postfixIncDec, punctuator, stack;
    ({ length } = input);
    lastIndex = 0;
    lastSignificantToken = "";
...
__name(requireJsTokens2, "requireJsTokens");
requireJsTokens2();
var reservedWords2 = {
  keyword: [
    "break",
...
function p2(n2 = false) {
  let e = C3(n2), i = /* @__PURE__ */ __name((r2, t, c, o) => {
    let l2 = "", s2 = 0;
    do
      l2 += r2.substring(s2, o) + c, s2 = o + t.length, o = r2.indexOf(t, s2);
    while (~o);
  ...
  for (let [r2, t] of h2) u3[r2] = e ? g(d2(t[0]), d2(t[1]), t[2]) : a2;
  return u3;
}
__name(p2, "p");
p2();
...
__name(positionToOffset, "positionToOffset");
...
__name(saveInlineSnapshots, "saveInlineSnapshots");
...
__name(replaceObjectSnap, "replaceObjectSnap");
...
__name(getObjectShapeEndIndex, "getObjectShapeEndIndex");
...
__name(prepareSnapString, "prepareSnapString");
...
__name(getCodeStartingAtIndex, "getCodeStartingAtIndex");
...
__name(replaceInlineSnap, "replaceInlineSnap");
...
__name(saveRawSnapshots, "saveRawSnapshots");
...
function requireNaturalCompare() {
  ...
  var naturalCompare2 = /* @__PURE__ */ __name(function(a3, b) {
...
__name(requireNaturalCompare, "requireNaturalCompare");
...
var serialize$12 = /* @__PURE__ */ __name((val, config2, indentation, depth, refs, printer2) => {
...
var test4 = /* @__PURE__ */ __name((val) => val && !!val._isMockFunction, "test");
var plugin2 = {
...
__name(addSerializer, "addSerializer");
function getSerializers() {
  return PLUGINS3;
}
__name(getSerializers, "getSerializers");
function testNameToKey(testName2, count) {
  return `${testName2} ${count}`;
}
__name(testNameToKey, "testNameToKey");
...
__name(keyToTestName, "keyToTestName");
...
__name(escapeBacktickString, "escapeBacktickString");
function printBacktickString(str) {
  return `\`${escapeBacktickString(str)}\``;
}
__name(printBacktickString, "printBacktickString");
...
__name(saveSnapshotFile, "saveSnapshotFile");
function prepareExpected(expected) {
  function findStartIndent() {
    var _a24, _b;
    const matchObject = /^( +)\}\s+$/m.exec(expected || "");
    const objectIndent = (_a24 = matchObject == null ? void 0 : matchObject[1]) == null ? void 0 : _a24.length;
    if (objectIndent) {
      return objectIndent;
    }
    const matchText = /^\n( +)"/.exec(expected || "");
  ...
  __name(findStartIndent, "findStartIndent");
...
__name(prepareExpected, "prepareExpected");
...
__name(deepMergeSnapshot, "deepMergeSnapshot");
var _a18;
var DefaultMap = (_a18 = class extends Map {
...
}, __name(_a18, "DefaultMap"), _a18);
var _a19;
var CounterMap = (_a19 = class extends DefaultMap {
  constructor() {
    super(() => 0);
...
}, __name(_a19, "CounterMap"), _a19);
var _a20;
var SnapshotState = (_a20 = class {
  ...
  static async create(testFilePath, options) {
    ...
    return new _a20(testFilePath, snapshotPath, content, options);
  }
  get environment() {
...
${JSON.stringify(stacks)}`);
      ...
      stack = ((_b = (_a24 = this.environment).processStackTrace) == null ? void 0 : _b.call(_a24, _stack)) || _stack;
      stack.column--;
...
}, __name(_a20, "SnapshotState"), _a20);
...
__name(createMismatchError, "createMismatchError");
var _a21;
var SnapshotClient = (_a21 = class {
  constructor(options = {}) {
  ...
  assert(options) {
    ...
    if (typeof properties === "object") {
      ...
      try {
        const pass2 = ((_b = (_a24 = this.options).isEqual) == null ? void 0 : _b.call(_a24, received, properties)) ?? false;
        if (!pass2) {
...
}, __name(_a21, "SnapshotClient"), _a21);

// node_modules/vitest/dist/chunks/date.W2xKR2qe.js
var RealDate = Date;
var now2 = null;
var _a22;
var MockDate = (_a22 = class extends RealDate {
  constructor(y2, m3, d2, h3, M, s2, ms) {
    ...
    Object.setPrototypeOf(date, _a22.prototype);
    return date;
  }
}, __name(_a22, "MockDate"), _a22);
...
// node_modules/vitest/dist/chunks/vi.DrftpPF8.js
var unsupported = [
...
function createExpectPoll(expect2) {
  return /* @__PURE__ */ __name(function poll(fn2, options = {}) {
    const state = getWorkerState();
    ...
    const proxy = new Proxy(assertion, {
      get(target, key, receiver) {
        ...
        return function(...args) {
          ...
          const promise = /* @__PURE__ */ __name(() => new Promise((resolve4, reject) => {
            let intervalId;
            let timeoutId;
            let lastError;
            const { setTimeout, clearTimeout } = getSafeTimers();
            ...
            timeoutId = setTimeout(() => {
              ...
              const rejectWithCause = /* @__PURE__ */ __name((cause) => {
                reject(copyStackTrace$1(new Error(`Matcher did not succeed in ${timeout}ms`, {
                  cause
                }), STACK_TRACE_ERROR));
              }, "rejectWithCause");
...
__name(createExpectPoll, "createExpectPoll");
...
__name(copyStackTrace$1, "copyStackTrace$1");
  ...
  (function(module2, exports2) {
    (function() {
      (function(chaiSubset2) {
        ...
        chai1.assert.containSubset = function(val, exp, msg) {
          new chai1.Assertion(val, msg).to.be.containSubset(exp);
        };
...
__name(requireChaiSubset, "requireChaiSubset");
...
__name(createAssertionMessage2, "createAssertionMessage");
...
__name(recordAsyncExpect2, "recordAsyncExpect");
var _client;
function getSnapshotClient() {
  if (!_client) {
    _client = new SnapshotClient({
      isEqual: /* @__PURE__ */ __name((received, expected) => {
...
__name(getSnapshotClient, "getSnapshotClient");
...
__name(getTestNames, "getTestNames");
var SnapshotPlugin = /* @__PURE__ */ __name((chai1, utils) => {
  ...
  for (const key of [
    ...
    utils.addMethod(chai1.Assertion.prototype, key, function(properties, message) {
      utils.flag(this, "_name", key);
      const isNot = utils.flag(this, "negate");
      if (isNot) {
  ...
  utils.addMethod(chai1.Assertion.prototype, "toMatchFileSnapshot", function(file, message) {
  ...
  utils.addMethod(chai1.Assertion.prototype, "toMatchInlineSnapshot", /* @__PURE__ */ __name(function __INLINE_SNAPSHOT__(properties, inlineSnapshot, message) {
  ...
  utils.addMethod(chai1.Assertion.prototype, "toThrowErrorMatchingSnapshot", function(message) {
  ...
  utils.addMethod(chai1.Assertion.prototype, "toThrowErrorMatchingInlineSnapshot", /* @__PURE__ */ __name(function __INLINE_SNAPSHOT__(inlineSnapshot, message) {
    const isNot = utils.flag(this, "negate");
    if (isNot) {
  ...
  utils.addMethod(chai1.expect, "addSnapshotSerializer", addSerializer);
}, "SnapshotPlugin");
use(JestExtend);
use(JestChaiExpect);
use(Subset);
...
function createExpect(test5) {
  const expect2 = /* @__PURE__ */ __name((value, message) => {
  ...
  expect2.soft = (...args) => {
    return expect2(...args).withContext({
      soft: true
    });
  };
  ...
  function assertions(expected) {
    const errorGen = /* @__PURE__ */ __name(() => new Error(`expected number of assertions to be ${expected}, but got ${expect2.getState().assertionCalls}`), "errorGen");
...
__name(requireGlobal, "requireGlobal");
var throwsOnProto_1;
...
__name(requireThrowsOnProto, "requireThrowsOnProto");
...
function requireCopyPrototypeMethods() {
  ...
  copyPrototypeMethods = /* @__PURE__ */ __name(function copyPrototypeMethods2(prototype) {
...
__name(requireCopyPrototypeMethods, "requireCopyPrototypeMethods");
var array;
...
function requireCalledInOrder() {
  ...
  __name(hasCallsLeft, "hasCallsLeft");
  ...
  __name(checkAdjacentCalls, "checkAdjacentCalls");
  function calledInOrder(spies) {
    var callMap = {};
    var _spies = arguments.length > 1 ? arguments : spies;
    return every2(_spies, checkAdjacentCalls.bind(null, callMap));
  }
  __name(calledInOrder, "calledInOrder");
  calledInOrder_1 = calledInOrder;
  return calledInOrder_1;
}
__name(requireCalledInOrder, "requireCalledInOrder");
var className_1;
...
__name(requireClassName, "requireClassName");
var deprecated = {};
...
function requireDeprecated() {
  ...
  (function(exports2) {
    exports2.wrap = function(func, msg) {
      var wrapped = /* @__PURE__ */ __name(function() {
...
__name(requireDeprecated, "requireDeprecated");
var every;
var hasRequiredEvery;
function requireEvery() {
  if (hasRequiredEvery) return every;
  hasRequiredEvery = 1;
  every = /* @__PURE__ */ __name(function every2(obj, fn2) {
    var pass = true;
    try {
...
function requireFunctionName() {
  ...
  functionName = /* @__PURE__ */ __name(function functionName2(func) {
    if (!func) {
      return "";
    }
    try {
...
function requireOrderByFirstCall() {
  ...
  __name(orderByFirstCall, "orderByFirstCall");
  orderByFirstCall_1 = orderByFirstCall;
  return orderByFirstCall_1;
}
__name(requireOrderByFirstCall, "requireOrderByFirstCall");
var _function;
...
__name(require_function, "require_function");
var map;
var hasRequiredMap;
function requireMap() {
...
__name(requirePrototypes, "requirePrototypes");
var typeDetect$1 = {
  exports: {}
};
...
__name(requireTypeDetect, "requireTypeDetect");
var typeOf;
...
function requireTypeOf() {
  ...
  typeOf = /* @__PURE__ */ __name(function typeOf2(value) {
    return type3(value).toLowerCase();
  }, "typeOf");
  return typeOf;
}
__name(requireTypeOf, "requireTypeOf");
var valueToString_1;
...
function requireFakeTimersSrc() {
  ...
  function withGlobal(_global) {
    ...
    const NOOP_ARRAY = /* @__PURE__ */ __name(function() {
      return [];
    }, "NOOP_ARRAY");
    const isPresent = {};
    ...
    const NativeIntl = isPresent.Intl ? Object.defineProperties(/* @__PURE__ */ Object.create(null), Object.getOwnPropertyDescriptors(_global.Intl)) : void 0;
    ...
    isPresent.Date = true;
    let FakePerformanceEntry = (_a24 = class {
    ...
    }, __name(_a24, "FakePerformanceEntry"), _a24);
    ...
    __name(checkIsNearInfiniteLimit, "checkIsNearInfiniteLimit");
    function resetIsNearInfiniteLimit() {
      isNearInfiniteLimit = false;
    }
    __name(resetIsNearInfiniteLimit, "resetIsNearInfiniteLimit");
    ...
    __name(nanoRemainder, "nanoRemainder");
...
${job.error.stack.split("\n").slice(matchedLineIndex + 1).join("\n")}`;
    ...
    __name(getInfiniteLoopError, "getInfiniteLoopError");
    function createDate() {
      var _a25;
      let ClockDate = (_a25 = class extends NativeDate {
        /**
        * @param {number} year
        * @param {number} month
        * @param {number} date
      ...
      }, __name(_a25, "ClockDate"), _a25);
      ClockDate.isFake = true;
      if (NativeDate.now) {
        ClockDate.now = /* @__PURE__ */ __name(function now3() {
          return ClockDate.clock.now;
        }, "now");
      }
      if (NativeDate.toSource) {
        ClockDate.toSource = /* @__PURE__ */ __name(function toSource() {
          return NativeDate.toSource();
        }, "toSource");
      }
      ClockDate.toString = /* @__PURE__ */ __name(function toString5() {
    ...
    function addTimer(clock, timer) {
      ...
      if (addTimerReturnsObject) {
        const res = {
          ...
          unref: /* @__PURE__ */ __name(function() {
            this.refed = false;
            return res;
          }, "unref"),
          hasRef: /* @__PURE__ */ __name(function() {
            return this.refed;
          }, "hasRef"),
    ...
    __name(compareTimers, "compareTimers");
    ...
    __name(firstTimerInRange, "firstTimerInRange");
    ...
    __name(getClearHandler, "getClearHandler");
    ...
    __name(getScheduleHandler, "getScheduleHandler");
    ...
    __name(createWarnOnce, "createWarnOnce");
...
To automatically clean-up native timers, use \`shouldClearNativeTimers\`.`);
    ...
    function uninstall(clock, config2) {
      ...
      return Object.keys(clock.timers).map(/* @__PURE__ */ __name(function mapper(key) {
    ...
    __name(hijackMethod, "hijackMethod");
    function doIntervalTick(clock, advanceTimeDelta) {
      clock.tick(advanceTimeDelta);
    }
    __name(doIntervalTick, "doIntervalTick");
    const timers = {
    ...
    function createClock(start, loopLimit) {
      ...
      __name(getTimeToNextFrame, "getTimeToNextFrame");
      ...
      __name(fakePerformanceNow, "fakePerformanceNow");
      ...
      clock.requestIdleCallback = /* @__PURE__ */ __name(function requestIdleCallback(func, timeout) {
      ...
      clock.cancelIdleCallback = /* @__PURE__ */ __name(function cancelIdleCallback(timerId) {
        return clearTimer(clock, timerId, "IdleCallback");
      }, "cancelIdleCallback");
      clock.setTimeout = /* @__PURE__ */ __name(function setTimeout(func, timeout) {
      ...
      if (typeof _global.Promise !== "undefined" && utilPromisify) {
        clock.setTimeout[utilPromisify.custom] = /* @__PURE__ */ __name(function promisifiedSetTimeout(timeout, arg) {
          return new _global.Promise(/* @__PURE__ */ __name(function setTimeoutExecutor(resolve4) {
            addTimer(clock, {
              func: resolve4,
              args: [
                arg
      ...
      clock.clearTimeout = /* @__PURE__ */ __name(function clearTimeout(timerId) {
        return clearTimer(clock, timerId, "Timeout");
      }, "clearTimeout");
      clock.nextTick = /* @__PURE__ */ __name(function nextTick(func) {
      ...
      clock.queueMicrotask = /* @__PURE__ */ __name(function queueMicrotask(func) {
        return clock.nextTick(func);
      }, "queueMicrotask");
      clock.setInterval = /* @__PURE__ */ __name(function setInterval(func, timeout) {
      ...
      clock.clearInterval = /* @__PURE__ */ __name(function clearInterval(timerId) {
        return clearTimer(clock, timerId, "Interval");
      }, "clearInterval");
      if (isPresent.setImmediate) {
        clock.setImmediate = /* @__PURE__ */ __name(function setImmediate(func) {
          return addTimer(clock, {
            func,
            args: Array.prototype.slice.call(arguments, 1),
            immediate: true
        ...
        if (typeof _global.Promise !== "undefined" && utilPromisify) {
          clock.setImmediate[utilPromisify.custom] = /* @__PURE__ */ __name(function promisifiedSetImmediate(arg) {
            return new _global.Promise(/* @__PURE__ */ __name(function setImmediateExecutor(resolve4) {
              addTimer(clock, {
                func: resolve4,
                args: [
                  arg
        ...
        clock.clearImmediate = /* @__PURE__ */ __name(function clearImmediate(timerId) {
          return clearTimer(clock, timerId, "Immediate");
        }, "clearImmediate");
      }
      clock.countTimers = /* @__PURE__ */ __name(function countTimers() {
        return Object.keys(clock.timers || {}).length + (clock.jobs || []).length;
      }, "countTimers");
      clock.requestAnimationFrame = /* @__PURE__ */ __name(function requestAnimationFrame(func) {
        const result = addTimer(clock, {
          func,
      ...
      clock.cancelAnimationFrame = /* @__PURE__ */ __name(function cancelAnimationFrame(timerId) {
        return clearTimer(clock, timerId, "AnimationFrame");
      }, "cancelAnimationFrame");
      clock.runMicrotasks = /* @__PURE__ */ __name(function runMicrotasks() {
        runJobs(clock);
      }, "runMicrotasks");
      function doTick(tickValue, isAsync, resolve4, reject) {
        ...
        __name(doTickInner, "doTickInner");
        ...
        compensationCheck = /* @__PURE__ */ __name(function() {
          if (oldNow !== clock.now) {
            tickFrom += clock.now - oldNow;
            tickTo += clock.now - oldNow;
        ...
        postTimerCall = /* @__PURE__ */ __name(function() {
          timer = firstTimerInRange(clock, previous, tickTo);
          previous = tickFrom;
        }, "postTimerCall");
        return doTickInner();
      }
      __name(doTick, "doTick");
      clock.tick = /* @__PURE__ */ __name(function tick(tickValue) {
        return doTick(tickValue, false);
      }, "tick");
      if (typeof _global.Promise !== "undefined") {
        clock.tickAsync = /* @__PURE__ */ __name(function tickAsync(tickValue) {
      ...
      clock.next = /* @__PURE__ */ __name(function next() {
        runJobs(clock);
      ...
      if (typeof _global.Promise !== "undefined") {
        clock.nextAsync = /* @__PURE__ */ __name(function nextAsync() {
          return new _global.Promise(function(resolve4, reject) {
            originalSetTimeout(function() {
              try {
                const timer = firstTimer(clock);
      ...
      clock.runAll = /* @__PURE__ */ __name(function runAll() {
        let numTimers, i;
        runJobs(clock);
      ...
      clock.runToFrame = /* @__PURE__ */ __name(function runToFrame() {
        return clock.tick(getTimeToNextFrame());
      }, "runToFrame");
      if (typeof _global.Promise !== "undefined") {
        clock.runAllAsync = /* @__PURE__ */ __name(function runAllAsync() {
          return new _global.Promise(function(resolve4, reject) {
            let i = 0;
            function doRun() {
              originalSetTimeout(function() {
      ...
      if (typeof _global.Promise !== "undefined") {
        clock.runToLastAsync = /* @__PURE__ */ __name(function runToLastAsync() {
          return new _global.Promise(function(resolve4, reject) {
            originalSetTimeout(function() {
              try {
                const timer = lastTimer(clock);
      ...
      clock.reset = /* @__PURE__ */ __name(function reset() {
        nanos = 0;
        clock.timers = {};
        clock.jobs = [];
        clock.now = start;
      }, "reset");
      clock.setSystemTime = /* @__PURE__ */ __name(function setSystemTime(systemTime) {
      ...
      clock.jump = /* @__PURE__ */ __name(function jump(tickValue) {
        const msFloat = typeof tickValue === "number" ? tickValue : parseTime(tickValue);
        const ms = Math.floor(msFloat);
    ...
    __name(createClock, "createClock");
    function install(config2) {
      ...
      __name(handleMissingTimer, "handleMissingTimer");
      let i, l2;
          ...
          if (nameOfMethodToReplace === "setTimeout") {
            ...
            timersPromisesModule.setInterval = (delay, value, options = {}) => ({
              [Symbol.asyncIterator]: () => {
                const createResolvable = /* @__PURE__ */ __name(() => {
                  let resolve4, reject;
...
__name(requireFakeTimersSrc, "requireFakeTimersSrc");
var fakeTimersSrcExports = requireFakeTimersSrc();
var _a23;
var FakeTimers = (_a23 = class {
...
function waitFor(callback, options = {}) {
  ...
  const { interval = 50, timeout = 1e3 } = typeof options === "number" ? {
    timeout: options
  } : options;
  const STACK_TRACE_ERROR = new Error("STACK_TRACE_ERROR");
  return new Promise((resolve4, reject) => {
    ...
    let timeoutId;
    let intervalId;
    const onResolve = /* @__PURE__ */ __name((result) => {
      if (timeoutId) {
        clearTimeout(timeoutId);
      }
      if (intervalId) {
    ...
    const handleTimeout = /* @__PURE__ */ __name(() => {
      if (intervalId) {
        clearInterval(intervalId);
      }
      let error = lastError;
    ...
    const checkCallback = /* @__PURE__ */ __name(() => {
      if (vi.isFakeTimers()) {
...
function createVitest() {
  ...
  let _timers;
  const timers = /* @__PURE__ */ __name(() => _timers || (_timers = new FakeTimers({
    global: globalThis,
  ...
  const utils = {
    ...
    waitUntil,
    hoisted(factory) {
      assertTypes(factory, '"vi.hoisted" factory', [
        "function"
      ]);
      return factory();
    },
...
__name(createVitest, "createVitest");
...
__name(_mocker, "_mocker");
function getImporter(name) {
  const stackTrace = createSimpleStackTrace({
    stackTraceLimit: 5
  });
...
// src/api/routes/auth/signin.controller.test.ts
test3("GET /signin should return status OK", async () => {
  const response = await app.inject({
    method: "GET",
    url: "/signin"
  });
  globalExpect(response.statusCode).toBe(200);
  globalExpect(response.json()).toEqual({
    status: "ok"
  });
});
